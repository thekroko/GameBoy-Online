...
';
	...
	protected function displaySettings() {
		...
		$this->writeAttribute('class', 'setting');
		$this->startElement('span');
		$this->text('Enable Channel 1 Audio:');
		$this->endElement();
		$this->startElement('input');
		$this->writeAttribute('type', 'checkbox');
		$this->writeAttribute('checked', 'checked');
		$this->writeAttribute('id', 'channel1');
		$this->endElement();
		$this->endElement();
        $this->startElement('div');
		$this->writeAttribute('class', 'setting');
		$this->startElement('span');
		$this->text('Enable Channel 2 Audio:');
		$this->endElement();
		$this->startElement('input');
		$this->writeAttribute('type', 'checkbox');
		$this->writeAttribute('checked', 'checked');
		$this->writeAttribute('id', 'channel2');
		$this->endElement();
		$this->endElement();
        $this->startElement('div');
		$this->writeAttribute('class', 'setting');
		$this->startElement('span');
		$this->text('Enable Channel 3 Audio:');
		$this->endElement();
		$this->startElement('input');
		$this->writeAttribute('type', 'checkbox');
		$this->writeAttribute('checked', 'checked');
		$this->writeAttribute('id', 'channel3');
		$this->endElement();
		$this->endElement();
        $this->startElement('div');
		$this->writeAttribute('class', 'setting');
		$this->startElement('span');
		$this->text('Enable Channel 4 Audio:');
		$this->endElement();
		$this->startElement('input');
		$this->writeAttribute('type', 'checkbox');
		$this->writeAttribute('checked', 'checked');
		$this->writeAttribute('id', 'channel4');
		$this->endElement();
		$this->endElement();
